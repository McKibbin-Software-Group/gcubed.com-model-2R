...
# links to the baseline projections pickle file in each of the experiment
# results directories.
#
# User configuration
###############################################################################
...
for experiment_script in experiment_scripts:
    ...
    for pickle_file in pickle_files:
        symbolic_link: Path = Path(experiment_results_folder) / pickle_file
        if not symbolic_link.exists():
            target = Path("path/to/target")
            link = Path("path/to/symlink")
            symbolic_link.symlink_to(baseline_results_folder / pickle_file)
