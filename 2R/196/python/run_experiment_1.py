...
experiment_directory_name: str = "experiment_1"

# Specify the name of the experiment design file
experiment_design_file_name: str = "design.csv"
# Specify the results folder where the baseline projections have been saved.
baseline_results_folder_name: str = "run_baseline"

# Specify the name of the file that is the saved baseline projections
baseline_file_name: str = "baseline_projections.joblib"
...
baseline_projections_file: Path = (
    root_results_directory_path / model_configuration.version / model_configuration.build / baseline_results_folder_name / baseline_file_name
)
assert (
...
for projections in runner.all_projections:
    projections.database_projections.to_csv(
        results_folder / f"{index} database projections.csv", index=True
    )
    projections.publishable_projections.to_csv(
        results_folder / f"{index} publishable projections.csv", index=True
    )
    index += 1
