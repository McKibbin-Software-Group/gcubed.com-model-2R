...
comparison_model_configuration_file_name: str = "configuration.csv"
...
comparison_model_configuration_file_path: Path = (
    model_directory_path.parent.parent
    / comparison_model_version
    / comparison_model_build
    / comparison_model_configuration_file_name
)
